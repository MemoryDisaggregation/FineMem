...
./start_microbench_multiple.sh 13 13 16 "cxl" 0 "different_node.csv" 1
printf ", " >> different_node.csv
...
printf ", " >> different_node.csv
./start_microbench_multiple.sh 13 13 16 "cxl" 0 "different_node.csv" 2
printf ", " >> different_node.csv
...
printf ", " >> different_node.csv
./start_microbench_multiple.sh 13 13 16 "cxl" 0 "different_node.csv" 3
printf ", " >> different_node.csv
...
printf ", " >> different_node.csv
./start_microbench_multiple.sh 13 13 16 "cxl" 0 "different_node.csv" 4
printf ", " >> different_node.csv
...
printf ", " >> different_node.csv
./start_microbench_multiple.sh 13 13 16 "cxl" 0 "different_node.csv" 5
printf ", " >> different_node.csv
...
printf ", " >> different_node.csv
./start_microbench_multiple.sh 13 13 16 "cxl" 0 "different_node.csv" 6
printf ", " >> different_node.csv
